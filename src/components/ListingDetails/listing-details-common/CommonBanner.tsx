   ...
   return (
      <div className="row">
         <div className="col-lg-6">
            <h3 className="property-titlee">Kinfolk: A New Play Reading.</h3>
            <div className="d-flex flex-wrap mt-10">
               <div className={`list-type text-uppercase mt-15 me-3 ${style_3 ? "bg-white text-dark fw-500" : "text-uppercase border-20"}`}>PWYW</div>
               <div className="address mt-15"><i className="bi bi-geo-alt"></i> 123 Auburn Ave NE, Atlanta, GA 30303
               </div>
            </div>
         </div>
         <div className="col-lg-6 text-lg-end">
            <div className="d-inline-block md-mt-40">
               <div className="price color-dark fw-500">Price: PWYW</div>
                <div className="est-price fs-20 mt-25 mb-35 md-mb-30">Date: <span
                    className="fw-500 color-dark">10/12/2025</span></div>
